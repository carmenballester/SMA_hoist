...
void carmen_controller_step(void)
{
  ...
  /* S-Function (stm32f4_regular_adc): '<S7>/Regular ADC' */

  /* ADC Block */
  ControlLogicReadSensorIntensityReadoutRegularADCStartConversion();
  carmen_controller_B.RegularADC = (float)
    ControlLogicReadSensorIntensityReadoutRegularADC_ConvertedValue[0];

  /* DataStoreWrite: '<S7>/Data Store Write' incorporates:
   *  Constant: '<S7>/Offset sensor'
   *  Sum: '<S7>/Sum'
   */
  carmen_controller_DWork.INTENSITY = carmen_controller_B.RegularADC -
    carmen_controller_P.Offsetsensor_Value;

  /* S-Function (stm32f4_digital_output): '<S23>/Digital Output3' */

  /* ControlLogicReadSensorSensorReadoutSelectSensorDigitalOutput3 */
  if (carmen_controller_P.Constant_Value_o == 0x01) {
  ...
  if (carmen_controller_DWork.MEASUR_REAL < 0) {
     ...
     */
    if ((u <= carmen_controller_P.Constant_Value) == 1) {
  ...
  if (carmen_controller_DWork.AUX == 0) {
     ...
     */
    carmen_controller_DWork.AUX = carmen_controller_P.Constant1_Value;
  ...
  /* MATLAB Function 'Control Logic/Read Sensor/Calculate the SMA real position/MATLAB Function1': '<S12>:1' */
  /* '<S12>:1:4' */
   ...
   */
  /* MATLAB Function 'PWM Output/MATLAB Function': '<S24>:1' */
   ...
   */
  /* MATLAB Function 'PWM Output/MATLAB Function1': '<S25>:1' */
  ...
  if (carmen_controller_M->Timing.TaskCounters.TID[1] == 0) {
    ...
    Target_VCP_Send_to_PC_BUF.dat3= carmen_controller_B.DataStoreRead2;
    ...
    carmen_controller_B.DataStoreRead2 = carmen_controller_DWork.INTENSITY;
  }
...
void carmen_controller_initialize(void)
{
  ...
  /* InitializeConditions for IfAction SubSystem: '<S9>/If Action Subsystem' */
  /* InitializeConditions for UnitDelay: '<S16>/UD' */
  carmen_controller_DWork.UD_DSTATE = carmen_controller_P.UD_InitialCondition;

  /* End of InitializeConditions for SubSystem: '<S9>/If Action Subsystem' */
  ...
  /* Level2 S-Function Block: '<S7>/Regular ADC' (stm32f4_regular_adc) */
  enable_ControlLogicReadSensorIntensityReadoutRegularADC();

  /* Level2 S-Function Block: '<S23>/Digital Output3' (stm32f4_digital_output) */
...
{
  /* Terminate for S-Function (stm32f4_regular_adc): '<S7>/Regular ADC' */

  /* terminate_ControlLogicReadSensorIntensityReadoutRegularADC(); */

  /* Terminate for S-Function (stm32f4_digital_output): '<S23>/Digital Output3' */
