...
typedef struct {
  real32_T RegularADC;                 /* '<S7>/Regular ADC' */
...
/* Parameters for system: '<S13>/If Action Subsystem1' */
...
struct Parameters_carmen_controller_ {
  ...
  real_T USBVCPSendSTM32F4_P6;         /* Expression: sampletime
                                        * Referenced by: '<S4>/USB VCP Send STM32F4'
                                        */
  real32_T Offsetsensor_Value;         /* Computed Parameter: Offsetsensor_Value
                                        * Referenced by: '<S7>/Offset sensor'
                                        */
  ...
  int16_T ShiftArithmetic1_Power2Exponent;/* Computed Parameter: ShiftArithmetic1_Power2Exponent
                                           * Referenced by: '<S22>/Shift Arithmetic1'
                                           */
  ...
  uint16_T USBVCPSendSTM32F4_P3[5];    /* Computed Parameter: USBVCPSendSTM32F4_P3
                                        * Referenced by: '<S4>/USB VCP Send STM32F4'
                                        */
  uint16_T USBVCPSendSTM32F4_P4[20];   /* Computed Parameter: USBVCPSendSTM32F4_P4
                                        * Referenced by: '<S4>/USB VCP Send STM32F4'
                                        */
  ...
  boolean_T Constant2_Value_o;         /* Computed Parameter: Constant2_Value_o
                                        ...
                                        */
  rtP_IfActionSubsystem1_carmen_c IfActionSubsystem1;/* '<S9>/If Action Subsystem1' */
  rtP_IfActionSubsystem1_carmen_c IfActionSubsystem1_h;/* '<S13>/If Action Subsystem1' */
};
...
extern Parameters_carmen_controller const carmen_controller_P;
 ...
 * '<S9>'   : 'carmen_controller/Control Logic/Read Sensor/Calculate the SMA real position/Anti-Slide'
 * '<S10>'  : 'carmen_controller/Control Logic/Read Sensor/Calculate the SMA real position/Calculate Offset'
 * '<S11>'  : 'carmen_controller/Control Logic/Read Sensor/Calculate the SMA real position/Check Update'
 * '<S12>'  : 'carmen_controller/Control Logic/Read Sensor/Calculate the SMA real position/MATLAB Function1'
 * '<S13>'  : 'carmen_controller/Control Logic/Read Sensor/Calculate the SMA real position/Anti-Slide/If Action Subsystem'
 * '<S14>'  : 'carmen_controller/Control Logic/Read Sensor/Calculate the SMA real position/Anti-Slide/If Action Subsystem1'
 * '<S15>'  : 'carmen_controller/Control Logic/Read Sensor/Calculate the SMA real position/Anti-Slide/If Action Subsystem/Compare To Constant'
 * '<S16>'  : 'carmen_controller/Control Logic/Read Sensor/Calculate the SMA real position/Anti-Slide/If Action Subsystem/Difference'
 * '<S17>'  : 'carmen_controller/Control Logic/Read Sensor/Calculate the SMA real position/Anti-Slide/If Action Subsystem/If Action Subsystem1'
 * '<S18>'  : 'carmen_controller/Control Logic/Read Sensor/Calculate the SMA real position/Anti-Slide/If Action Subsystem/If Action Subsystem2'
 * '<S19>'  : 'carmen_controller/Control Logic/Read Sensor/Calculate the SMA real position/Anti-Slide/If Action Subsystem/If Action Subsystem2/Increment Stored Integer'
 * '<S20>'  : 'carmen_controller/Control Logic/Read Sensor/Calculate the SMA real position/Calculate Offset/If Action Subsystem'
 * '<S21>'  : 'carmen_controller/Control Logic/Read Sensor/Calculate the SMA real position/Check Update/If Action Subsystem2'
 * '<S22>'  : 'carmen_controller/Control Logic/Read Sensor/Sensor Readout/Data Composer'
 * '<S23>'  : 'carmen_controller/Control Logic/Read Sensor/Sensor Readout/Select Sensor'
 * '<S24>'  : 'carmen_controller/PWM Output/MATLAB Function'
 * '<S25>'  : 'carmen_controller/PWM Output/MATLAB Function1'
 */
