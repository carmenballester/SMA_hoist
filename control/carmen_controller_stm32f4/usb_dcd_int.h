 ...
 * @{
 */
#define CLEAR_IN_EP_INTR(epnum,intr)   diepint.d32=0; diepint.b.intr = 1; USB_OTG_WRITE_REG32(&pdev->regs.INEP_REGS[epnum]->DIEPINT,diepint.d32);
#define CLEAR_OUT_EP_INTR(epnum,intr)  doepint.d32=0; doepint.b.intr = 1; USB_OTG_WRITE_REG32(&pdev->regs.OUTEP_REGS[epnum]->DOEPINT,doepint.d32);
