...
__ALIGN_BEGIN uint8_t USB_Rx_Buffer [APP_RX_DATA_SIZE] __ALIGN_END __attribute__
  ((section(".ccm")));                 //[2048][CDC_DATA_MAX_PACKET_SIZE] experimental
...
__ALIGN_BEGIN uint8_t APP_Rx_Buffer [APP_RX_DATA_SIZE] __ALIGN_END __attribute__
  ((section(".ccm")));
