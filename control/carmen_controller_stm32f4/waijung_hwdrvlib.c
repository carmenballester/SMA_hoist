...
/* ########################################################################
 * Name: <S7>/Regular ADC
 * Id: ControlLogicReadSensorIntensityReadoutRegularADC
 * ########################################################################
 */

/* ControlLogicReadSensorIntensityReadoutRegularADC */
uint16_t ControlLogicReadSensorIntensityReadoutRegularADC_ConvertedValue[1];
void enable_ControlLogicReadSensorIntensityReadoutRegularADC(void)
{
  ...
  DMA_InitStructure.DMA_Channel =
    ControlLogicReadSensorIntensityReadoutRegularADC_DMA_CHANNEL;
  ...
  DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)
    ControlLogicReadSensorIntensityReadoutRegularADC_ADC_DR_ADDRESS;
  DMA_InitStructure.DMA_Memory0BaseAddr = (uint32_t)&
    ControlLogicReadSensorIntensityReadoutRegularADC_ConvertedValue;
  DMA_InitStructure.DMA_BufferSize = 1;
  DMA_Init(ControlLogicReadSensorIntensityReadoutRegularADC_DMA_STREAM,
           &DMA_InitStructure);
  DMA_Cmd(ControlLogicReadSensorIntensityReadoutRegularADC_DMA_STREAM, ENABLE);
  ...
  ADC_InitStructure.ADC_ExternalTrigConv = ADC_ExternalTrigConv_Ext_IT11;// avoid assert_fail
...
void ControlLogicReadSensorIntensityReadoutRegularADCStartConversion(void)
{
  /* Start ADC Software Conversion */
  ADC_SoftwareStartConv(ADC1);

  /* Wait for ADA1-DMA transfer complete */
  while (!DMA_GetFlagStatus
         (ControlLogicReadSensorIntensityReadoutRegularADC_DMA_STREAM,
          ControlLogicReadSensorIntensityReadoutRegularADC_DMA_TC_FLAG)) ;

  /* Clear */
  DMA_ClearFlag(ControlLogicReadSensorIntensityReadoutRegularADC_DMA_STREAM,
                ControlLogicReadSensorIntensityReadoutRegularADC_DMA_TC_FLAG);
}

void disable_ControlLogicReadSensorIntensityReadoutRegularADC(void)
{
  /* Disable ADC1 DMA */
  ...
  /* Disable DMA */
  DMA_Cmd(ControlLogicReadSensorIntensityReadoutRegularADC_DMA_STREAM, DISABLE);
}

/* ########################################################################
 * Name: <S23>/Digital Output3
