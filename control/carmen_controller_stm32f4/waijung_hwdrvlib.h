 ...
 */
/* Conversion result */
extern uint16_t ControlLogicReadSensorIntensityReadoutRegularADC_ConvertedValue[];

/* ADC1 Configuration */
#define ControlLogicReadSensorIntensityReadoutRegularADC_ADC_DR_ADDRESS ADC1_DR_ADDRESS

/* ADC1 DR Address */
#define ADC1_DR_ADDRESS                ((uint32_t)0x4001204C)

/* DMA */
#define ControlLogicReadSensorIntensityReadoutRegularADC_DMA_CHANNEL DMA_Channel_0
#define ControlLogicReadSensorIntensityReadoutRegularADC_DMA_STREAM DMA2_Stream4
#define ControlLogicReadSensorIntensityReadoutRegularADC_DMA_TC_FLAG DMA_FLAG_TCIF4
...
#define UC3M_USBVCP_Send_Byte_Count    16
