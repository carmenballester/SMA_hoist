...
static const char * c1_debug_family_names[11] = { "p", "m", "n", "rel_grad",
  "KG", "nargin", "nargout", "amplitude", "gradient", "pid", "control" };
  ...
  (SFc1_carmen_controller_HOST_2013InstanceStruct *chartInstance)
{
  ...
  real32_T *c1_b_amplitude;
  real32_T *c1_b_control;
  c1_b_pid = (real32_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c1_b_control = (real32_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_b_gradient = (real32_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c1_b_amplitude = (real32_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  _SFD_DATA_RANGE_CHECK((real_T)*c1_b_amplitude, 0U);
  _SFD_DATA_RANGE_CHECK((real_T)*c1_b_gradient, 1U);
  _SFD_DATA_RANGE_CHECK((real_T)*c1_b_control, 2U);
  _SFD_DATA_RANGE_CHECK((real_T)*c1_b_pid, 3U);
  chartInstance->c1_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  c1_hoistedGlobal = *c1_b_amplitude;
  c1_b_hoistedGlobal = *c1_b_gradient;
  c1_c_hoistedGlobal = *c1_b_pid;
  c1_amplitude = c1_hoistedGlobal;
  c1_gradient = c1_b_hoistedGlobal;
  c1_pid = c1_c_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_n, 2U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_rel_grad, 3U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 6U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_amplitude, 7U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_gradient, 8U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_pid, 9U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_control, 10U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("exp"), "name", "name", 8);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("single"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2370106216U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2565541578U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(722074447U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(170991651U);
}
...
mxArray *sf_c1_carmen_controller_HOST_2013_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("iUVAA9Af8kxRksFO21QsLE");
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"amplitude");
          _SFD_SET_DATA_PROPS(1,1,1,0,"gradient");
...

        {
          ...
          real32_T *c1_control;
          real32_T *c1_pid;
          c1_pid = (real32_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c1_control = (real32_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c1_gradient = (real32_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c1_amplitude = (real32_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c1_amplitude);
          _SFD_SET_DATA_VALUE_PTR(1U, c1_gradient);
          _SFD_SET_DATA_VALUE_PTR(2U, c1_control);
          _SFD_SET_DATA_VALUE_PTR(3U, c1_pid);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c1_carmen_controller_HOST_2013(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2594141865U));
  ssSetChecksum1(S,(3171423438U));
  ssSetChecksum2(S,(3281058887U));
  ssSetChecksum3(S,(2747847104U));
