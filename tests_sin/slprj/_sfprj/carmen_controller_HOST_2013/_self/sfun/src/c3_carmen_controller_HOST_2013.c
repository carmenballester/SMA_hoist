...
static real32_T c3_emlrt_marshallIn
  (SFc3_carmen_controller_HOST_2013InstanceStruct *chartInstance, const mxArray *
   c3_reset, const char_T *c3_identifier);
  ...
  (SFc3_carmen_controller_HOST_2013InstanceStruct *chartInstance)
{
  ...
  real32_T *c3_error_p;
  real32_T *c3_reset;
  c3_reset = (real32_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  ...
  c3_c_y = NULL;
  sf_mex_assign(&c3_c_y, sf_mex_create("y", &c3_b_u, 1, 0U, 0U, 0U, 0), FALSE);
   ...
   c3_st)
{
  ...
  *c3_error_p = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 0)), "error_p");
  *c3_reset = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
    1)), "reset");
  chartInstance->c3_is_active_c3_carmen_controller_HOST_2013 =
    c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
  ...
  (SFc3_carmen_controller_HOST_2013InstanceStruct *chartInstance)
{
  ...
  real32_T *c3_b_error;
  c3_b_reset = (real32_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c3_b_reset, 2U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_m, 0U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_n, 1U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 3U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_error, 4U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_error_p, 5U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  ...
  if (CV_EML_IF(0, 1, 0, c3_error < 0.0F)) {
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("exp"), "name", "name", 3);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("single"), "dominantType",
                  "dominantType", 3);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mrdivide"), "name", "name", 5);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("single"), "dominantType",
                  "dominantType", 5);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2741701491U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1996884757U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2414473639U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4161164860U);
}
...
mxArray *sf_c3_carmen_controller_HOST_2013_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("J4Yc8jmJlIouUccFUoTWwH");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,132,146,182,220);
...
static void mdlSetWorkWidths_c3_carmen_controller_HOST_2013(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3959471573U));
  ssSetChecksum1(S,(3860875869U));
  ssSetChecksum2(S,(3527418531U));
  ssSetChecksum3(S,(640241995U));
