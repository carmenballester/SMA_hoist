  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1717085304U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1442952733U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(73874012U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(400020957U);
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "iUVAA9Af8kxRksFO21QsLE") == 0) {
          extern mxArray
     ...
     case 2:
      {
        if (strcmp(aiChksum, "8pcIJ7ASjXVDkByzTAR5cH") == 0) {
          extern mxArray
     ...
     case 3:
      {
        if (strcmp(aiChksum, "SnPoXCFnTzpVnqnGo5evlG") == 0) {
          extern mxArray
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "lPVzeP49mqBD0nPUq48jPB") == 0) {
          extern mxArray
     ...
     case 2:
      {
        if (strcmp(tpChksum, "0tnYzUZ7xHCqTOcuHXrG3C") == 0) {
          extern mxArray
     ...
     case 3:
      {
        if (strcmp(tpChksum, "VuC9dC5nxvczmGdczjRKnD") == 0) {
          extern mxArray
